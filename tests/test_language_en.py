...
from tests import HUNDREDS_DIRECTORY, PERMUTATION_DIRECTORY, \
    ORDINALS_DIRECTORY, ORDINALS_PERMUTATION_DIRECTORY
...
def test_parse_ordinal():
    _test_files(ORDINALS_DIRECTORY, LANG, is_ordinal=True)


def test_parse_ordinal_permutations():
    _test_files(ORDINALS_PERMUTATION_DIRECTORY, LANG)
