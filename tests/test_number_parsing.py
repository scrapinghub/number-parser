...
from number_parser import parse, parse_fraction, parse_number
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "tres mil veintitrés millones mil cuatrocientos treinta y dos",
            3_023_001_432,
            "es",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "doscientos cincuenta y doscientos treinta y uno y doce",
            "250 y 231 y 12",
            "es",
        ),
    ],
...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            "two million three thousand and nineteen/two thousand and nineteen",
            "2003019/2019",
            "en",
        ),
